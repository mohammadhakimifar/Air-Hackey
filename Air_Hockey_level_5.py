...
def game_level_5():
    ...
    other_line2_lenght=80
    my_door_lenght=140
    other_door_lenght=80
    other_door_x=0
    other_door_x_change=0
    score=-3
    intro=True
    i=0
    ...
    end_other_line_y=30
    other_line_change=0
    start_other_line2_x=50
    start_other_line2_y=130
    end_other_line2_x=other_line2_lenght+50
    end_other_line2_y=130
    other_line2_change=0
    while intro:
        if i==0:
            text.message_display("Level 5",sheet_w/2,sheet_h/2,white,50)
            time.sleep(2)
        ...
        if end_other_line_x<=290:
            ...
            start_other_line_x+=other_line_change
            end_other_line_x+=other_line_change
        if end_other_line2_x<=290:
            other_line2_change+=0.0007
            start_other_line2_x+=other_line2_change
            end_other_line2_x+=other_line2_change
        elif start_other_line2_x>=100:
            other_line2_change-=0.0007
            start_other_line2_x+=other_line2_change
            end_other_line2_x+=other_line2_change
        if other_door_x<=250:
            other_door_x_change+=0.0003
            other_door_x+=other_door_x_change
        elif other_door_x>=0:
            other_door_x_change-=0.0003
            other_door_x+=other_door_x_change
        ...
        if start_other_line_x<=int(ball_x)<=end_other_line_x and start_other_line_y>=int(ball_y)-15:
            move_angle=move_angle*(-1)
        if start_other_line2_x<=int(ball_x)<=end_other_line2_x and start_other_line2_y>=int(ball_y)-15:
            move_angle=move_angle*(-1)
        if sheet_w/2-my_door_lenght/2-15<=int(ball_x)<=sheet_w/2+my_door_lenght/2+15 and sheet_h==int(ball_y)+15:
            ...
            print(score)
        if other_door_x<=int(ball_x)<=other_door_x+other_door_lenght and 0==int(ball_y)-15:
            score+=1
        ...
        pygame.draw.line(sheet,white,(start_other_line2_x,start_other_line2_y),(end_other_line2_x,end_other_line2_y),5)

        pygame.draw.rect(sheet,green,(sheet_w/2-my_door_lenght/2,sheet_h-20,my_door_lenght,20))
        pygame.draw.rect(sheet,green,(other_door_x,0,other_door_lenght,20))
